...
/* CVE-2020-12825: cr_parser_parse_any_core / parse_block_core
 * recurse on '(' / '[' / '{'. Cap depth so a crafted sheet cannot
 * overflow the stack. */
                        ...
                        if (status == CR_OK) {
                                if (import_string
                                    ...
                                    && PRIVATE (a_this)->sac_handler->import_style) {
                                        ...
                                        /* Fetching @import URLs is not
                                         * implemented and will not be.
                                         * import_style is notify-only.
                                         */
